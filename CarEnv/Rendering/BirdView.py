...
def from_pil(im: Image, format: cairo.Format=cairo.FORMAT_ARGB32) -> cairo.ImageSurface:
    """
    Converts a Pillow Image to a Cairo ImageSurface according to official docs:
    See https://pycairo.readthedocs.io/en/latest/tutorial/pillow.html
